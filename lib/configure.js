var fs = require('fs'),
  ...
  NodeResolver = require('node-version-resolver'),
  debug = require('debug')('lone:configure');

function nodeVersion(opts, fn){
  new NodeResolver(function(resolver){
    config.node = {version: resolver.satisfy(opts.node || options.node.default)};
    fn();
  });
}
